...
- **Topic:** 1.2 Short-Term Debt Cycle.
...
SUBSECTION
  ...
  IN-SCOPE:          5-10 year business cycle; central-bank-driven credit expansion and contraction; yield-curve indicators; recession indicators; late-cycle vs mid-cycle detection; six-phase cycle template.
  OUT-OF-SCOPE:      Long-term debt cycle — covered by 1.3; deleveraging levers — covered by 1.4; productivity trend — covered by 1.1.
...
NAMED FRAMEWORK COMPONENTS (TOPIC-BOUND, R17 ENFORCEMENT)
  ...
  1. **six cycle phases** — items: early cycle; mid cycle; late cycle; recession early; recession late; transitional
     ...
     Operationalization required: §5 must define a phase-classifier transform; §6 must emit phase tag; §7 must show ≥3 cases at different phases; §11 must row each phase boundary.
...
DELIVERABLE
  ...
  research_v2/02_short_term_debt_cycle.md. Document title (the H1 at the top of the
  ...
  research_v2/02_short_term_debt_cycle_quote_audit.md per R21.
...
HARD RULES (every rule binding; one violation = rejection)
  ...
  R21. VERBATIM QUOTE AUDIT APPENDIX (BLOCKING). In addition to the
       ...
       structure:
           ...
           # Quote Audit — 1.2 Short-Term Debt Cycle
...
After the model writes its main deliverable to `research_v2/02_short_term_debt_cycle.md` and the quote-audit appendix to `research_v2/02_short_term_debt_cycle_quote_audit.md`, run these checks IN ORDER:
