...
**Layer 2 commit:** `f14dec0` (2026-04-24).
**Final structural state:** S2=2995w (≤3000 ✓), S5 §1=74w (≤100 ✓), R4=6.03 (≥5.67 ✓), R7=30 markers (≥21 ✓), P1 palette 12 unique hex ✓, S6 7-col table ✓, S4 sub-sections ✓.
...
| F9 — COFER methodology stale (2025Q3 unallocated eliminated) | MAJOR | **VALID-patched** | WebSearch confirmed IMF TN Nov 2025: starting 2025Q3 with revisions back to 2000Q1, IMF eliminates "unallocated" portion via stratified-mean + carry-forward imputation. Target previously locked to "allocated" definition. | §4 `FX_res_USD` description updated: "legacy 'allocated' through 2025Q2; from 2025Q3 IMF eliminates unallocated via imputation per TN Nov 2025". |
