...
def main() -> None:
    ...
    lines.append("")
    lines.append("### Check 2 — Local Dalio-exhaustion grep on cluster F: 8 of 12 done")
    lines.append("")
    ...
    lines.append("")
    lines.append("4 cluster-F entries pending fetch (sources NOT in local cache):")
    lines.append("06-#2 (CWO Ch 1), 08-#4 (Principles 2017 commercial book — R9 fair-use),")
    lines.append("09-#1 (Robbins reprint), 09-#2 (Our Thoughts 2015).")
    lines.append("")
    ...
    lines.append("")
    lines.append("### Check 3 — Verify already-closed-here citations: 2 of 7 done")
    lines.append("")
    ...
    lines.append("")
    lines.append("5 remaining `already-closed-here` citations NOT YET RE-VERIFIED:")
    lines.append("01-#5 Hamilton 2018 NBER WP 23429; 02-#3 Estrella-Mishkin 1996 (NY Fed 403'd);")
    lines.append("02-#4 NY Fed probit + Sahm 2019; 10-#1 Grinold 1989 / Grinold-Kahn 2000;")
    lines.append("11-#1 AFP 2012 / Qian 2005. To verify in Phase 1 prep or Phase 3 step 1.")
    lines.append("")
    ...
    lines.append("| Cluster-F bucket assignment (12) | 8 evidence-grounded, 4 pending fetch | MEDIUM-HIGH |")
    lines.append("| Already-closed-here (7) | 2 verified, 5 pending | MEDIUM |")
